...
import {Heading, Center, Image, Text, Box, Stack, Button, HStack } from "@chakra-ui/react"
...
export default function Home() {
  return (
    ...
    <Image src="/images/frame12.png" alt="Frame 12" width="348px" height="336px" style={{ borderRadius: "20px", position: "absolute", top: "-15px", left: "420px", zIndex: 2,}} />
    </div>
    


    <Center marginTop = "85px"> 
    ...
    <Box background = "green.100" borderRadius = "25px" width = "93%" justifyContent = "center" style={{ margin: "0 auto", }}>
      ...
      <Button background="green.200" borderRadius="50px" width="70px" height="70px" display="flex" alignItems="center" justifyContent="center" padding="0" style={{ position: "relative", top: "-190px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "-26px" }}>
        ...
        <Image src = "/images/f2.png" alt = "F2" style = {{width: "1101px", height: "349px", borderRadius: "20px" }}/>
        </div>
    ...
    {/* <Box>
    <div style = {{display: "flex", justifyContent: "center"}}>
      <Text width = "465px" height = "55px" fontFamily = "Poppins" fontWeight = "500" fontSize = "50px" lineHeight = "55px" letterSpacing = "0%" mb = "12">Words on the street</Text>
    </div>
      <div style = {{display: "flex", justifyContent: "center"}}>
      <Image src = "/images/f10.png" alt = "F10" width = "1025px" height = "824px" mb = "12"/>
      </div>
    </Box> */}
